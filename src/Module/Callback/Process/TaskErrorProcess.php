...
class TaskErrorProcess extends AbstractProcess
{
    ...
    protected function run($arg)
    {
        ...
        try {
            ...
            /** 2分钟重新通信一次 */
            \EasySwoole\Component\Timer::getInstance()->loop(10 * 1 * 1000, function () {

                Logger::getInstance()->log('2毫秒', Logger::LOG_LEVEL_INFO, 'callback-process');
...
//            }
            ...
            Logger::getInstance()->log($throwable->getMessage(), Logger::LOG_LEVEL_INFO, 'callback-process');
        }
    }
